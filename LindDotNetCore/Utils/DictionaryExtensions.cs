...
namespace System.Collections.Generic
{
    ...
    public static class DictionaryExtensions
    {
        ...
        {
            m_values = System.Web.HttpUtility.UrlDecode(m_values);
            var arr = m_values.Split(new char[] { '?' });
            m_values = arr.Length > 1 ? arr[1] : arr[0];
        ...
        public static NameValueCollection ToNameValueCollection(this object obj)
        {
            ...
            {
                nv.Add(item, (string)dic[item]);
            }
            return nv;
        }

        /// <summary>
        /// 将对象转dic，value为string
        /// </summary>
        /// <param name="obj"></param>
        /// <returns></returns>
        public static IDictionary<string, string> ToDictionaryString(this object obj)
        {
            IDictionary<string, string> dic = new Dictionary<string, string>();
        ...
        /// 集合对象
        /// </summary>
        private static string[] ListNameArr = { "List`1", "IList`1", "IEnumerable`1", "ICollection`1" };
        ...
        private static void ReGenerate(
            object obj,
            PropertyInfo p,
            Dictionary<string, object> prefix,
